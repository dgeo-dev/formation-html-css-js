...
<head>
  ...
  <title>Titre de ma page d'accueil</title>
    ...
    <div class="container">
      <div class="grid">
        <div class="hero__item left">
          ...
          <h1 class="title">Hello, Je suis John Doe de Paris.</h1>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        </div>
        <div class="hero__item right">
          <div class="hero__avatar">
            <img src="./img/avatar.png" alt="John Doe - Développeur Freelance sur Paris" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="grid">
        <div class="grid__item">
          <img src="./img/person.jpg" alt="John Doe - Développeur Freelance sur Paris" />
        </div>
        <div class="grid__item">
          ...
          <p>
            ...
            <strong>Mot ou portion de phrase importante</strong>
            Exercitationem dolores perspiciatis veniam dolore saepe, quas
            similique velit aut optio vel. Nostrum nobis voluptate et nihil
            rem nam, maxime quidem reiciendis.
          </p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Exercitationem dolores perspiciatis veniam dolore saepe, quas
    ...
    <div class="container">
      <div class="section-header">
        ...
        <p>
          ...
          laborum, voluptate eos perferendis animi accusantium quibusdam ipsa
          consequuntur, voluptatum sequi impedit minus voluptatibus esse
          quidem laboriosam tenetur? Iusto, inventore necessitatibus.
        </p>
      </div>
      <div class="grid">
        <div class="grid__item">
    ...
    <div class="container">
      <div class="section-header">
        ...
        <p>
          ...
          vero sed similique et odit eaque voluptate doloribus nisi nobis
          animi sunt quisquam sequi pariatur fuga placeat commodi, suscipit
          quaerat fugiat?
        </p>
      </div>
      <div class="grid">
        ...
        <div class="grid__item">
          ...
          <div class="progressbar">
            <div class="bar" data-width="90">PHP</div>
          </div>
          <div class="progressbar">
            <div class="bar" data-width="85">NODE</div>
          </div>
          <div class="progressbar">
            <div class="bar" data-width="75">REACT</div>
          </div>
        ...
        <div class="grid">
          <div class="grid__item">
            <div class="card" data-category="web">
              <img src="https://picsum.photos/600/400?random=1" class="card__image"
                    ...
                    <div class="grid__item">
                      ...
                      <p class="category">
                        <svg width="15" height="15" aria-hidden="true" focusable="false" data-prefix="fas"
                          data-icon="tag" class="svg-inline--fa fa-tag fa-w-16" role="img"
          ...
          <div class="grid__item">
            <div class="card" data-category="app">
              <img src="https://picsum.photos/600/400?random=3" class="card__image"
                alt="Projet site de la ville de lyon" />
              <div class="card__inner">
                <h3 class="card__title">Titre du projet</h3>
          ...
          <div class="grid__item">
            <div class="card" data-category="web">
              <img src="https://picsum.photos/600/400?random=4" class="card__image"
                alt="Projet site de la ville de lyon" />
              <div class="card__inner">
                <h3 class="card__title">Titre du projet</h3>
                <p class="category">Développement Web</p>
          ...
          <div class="grid__item">
            <div class="card" data-category="design">
              <img src="https://picsum.photos/600/400?random=5" class="card__image"
                alt="Projet site de la ville de lyon" />
              <div class="card__inner">
                <h3 class="card__title">Titre du projet</h3>
                <p class="category">Refonte graphique</p>
          ...
          <div class="grid__item">
            <div class="card" data-category="app">
              <img src="https://picsum.photos/600/400?random=6" class="card__image"
                alt="Projet site de la ville de lyon" />
              <div class="card__inner">
                <h3 class="card__title">Titre du projet</h3>
                <p class="category">Application</p>
  ...
  <section class="contact" id="contact">
    <div class="container">
      ...
      <form action="contact.php" class="form">
        ...
        <label for="name">
          <textarea type="text" name="text" id="text" placeholder="Message"></textarea>
        </label>
